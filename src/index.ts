...
program
  ...
  .option('-w, --whitelist', 'Whitelisted properties')
  .option('-b, --blacklist', 'Blacklisted properties')
  .parse(process.argv);
...
if (program.input) {
    ...
    console.log(converter.convertJsonToCsv(file).csv);
    // {blackList: program.blacklist, whiteList: program.whitelist}
}
